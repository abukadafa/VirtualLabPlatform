...
const FacilitatorSubmissions: React.FC = () => {
    ...
    const toggleSelectAll = () => {
        if (selectedSubmissionIds.size === filteredSubmissions.length) {
            ...
            setSelectedSubmissionIds(new Set(filteredSubmissions.map((s: Submission) => s._id)));
        }
    };
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <h1 className="text-lg font-extrabold text-[#1e3a8a] leading-tight">Student Submissions</h1>
                            </div>
                        </div>
                        <div className="flex items-center gap-3">
                            <button
                                onClick={logout}
                                className="px-4 py-2 bg-slate-100 hover:bg-slate-200 text-[#1e3a8a] rounded-lg transition text-xs font-bold border border-slate-200"
                            >
                                Logout
                            </button>
                        </div>
                    ...
                    <div className="flex flex-col md:flex-row gap-4 items-end">
                        <div className="flex-1 space-y-1 w-full">
                            ...
                            <div className="relative">
                                ...
                                <select
                                    ...
                                    className="w-full bg-slate-50 border border-slate-200 rounded-lg pl-10 pr-4 py-2 text-slate-900 appearance-none focus:ring-2 focus:ring-[#1e3a8a] outline-none"
                                >
                        ...
                        <div className="flex-grow space-y-1 w-full">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full bg-slate-50 border border-slate-200 rounded-lg pl-10 pr-4 py-2 text-slate-900 focus:ring-2 focus:ring-[#1e3a8a] outline-none"
                                />
                            </div>
                        </div>
                        <div className="flex gap-2">
                            <button
                                ...
                                className={`px-4 py-2 rounded-lg font-bold transition text-xs ${filterStatus === 'all'
                                    ? 'bg-[#1e3a8a] text-white shadow-md'
                                    : 'bg-slate-100 text-[#1e3a8a] hover:bg-slate-200 outline-none'
                                    }`}
                            >
                                All
                            </button>
                            <button
                                ...
                                className={`px-4 py-2 rounded-lg font-bold transition text-sm ${filterStatus === 'pending'
                            ...
                            <button
                                ...
                                className={`px-4 py-2 rounded-lg font-bold transition text-sm ${filterStatus === 'graded'
