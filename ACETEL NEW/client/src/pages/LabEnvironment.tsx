                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <h1 className="text-lg font-extrabold text-[#1e3a8a] leading-tight">{lab.name}</h1>
                            </div>
                        </div>
                        <div className="flex items-center gap-3">
                            {sessionState === 'idle' && (
                                <button
                                    ...
                                    disabled={isLoading}
                                    className="flex items-center gap-2 px-6 py-2.5 bg-[#1e3a8a] hover:bg-[#1e3a8a]/90 text-white rounded-lg transition font-bold shadow-md disabled:opacity-50 text-sm"
                                >
                                    {isLoading ? (
                            ...
                            {(sessionState === 'active' || sessionState === 'paused') && (
                                <button
                                    onClick={stopSession}
                                    disabled={isLoading}
                                    className="flex items-center gap-2 px-6 py-2.5 bg-red-600 hover:bg-red-700 text-white rounded-lg transition font-bold shadow-md disabled:opacity-50 text-sm"
                                >
                                    {isLoading ? (
                                        <Loader2 className="w-4 h-4 animate-spin" />
                                    ) : (
                ...
                {sessionState === 'idle' && (
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        <div className="lg:col-span-2 bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
                            <h2 className="text-xl font-bold text-[#1e3a8a] mb-4">Lab Description</h2>
                            <p className="text-slate-600 mb-6">{lab.description}</p>
                            
                            <h3 className="text-lg font-bold text-[#1e3a8a] mb-3">Pre-installed Software</h3>
                            <div className="grid grid-cols-2 gap-3">
                                {lab.software.map((sw, index) => (
                                    ...
                                    >
                                        <div className="w-2 h-2 bg-[#008751] rounded-full"></div>
                                        <span className="text-slate-700 text-sm font-medium">{sw}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
                        ...
                        <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
                            <h3 className="text-lg font-bold text-[#1e3a8a] mb-4">Lab Capacity</h3>
                            <div className="flex items-center gap-3 p-4 bg-slate-50 rounded-lg mb-4 border border-slate-100">
                                <Users className="w-8 h-8 text-[#1e3a8a]" />
                                <div>
                                    <div className="text-2xl font-bold text-[#1e3a8a]">{lab.capacity}</div>
                                    <div className="text-sm text-slate-500 font-medium">Max Concurrent Users</div>
                                </div>
                            </div>
