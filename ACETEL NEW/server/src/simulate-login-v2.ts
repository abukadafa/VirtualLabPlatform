...
async function runTests() {
    let finalLog = '';
    finalLog += await simulateLogin('Admin@virtuallab.com', 'admin123', 'admin');
    finalLog += '-------------------\n';
    finalLog += await simulateLogin('admin@virtuallab.com', 'admin123', 'admin');
    finalLog += '-------------------\n';
    finalLog += await simulateLogin('admin@virtuallab.com', 'admin123', 'student');

    fs.writeFileSync('simulate-login-output.txt', finalLog);
}
