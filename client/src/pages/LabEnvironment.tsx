                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-green-600 text-[10px] font-black uppercase tracking-widest">{lab.type} Laboratory</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-3">
                            {sessionState === 'idle' && (
                                <button
                                    ...
                                    disabled={isLoading}
                                    className="flex items-center gap-2 px-6 py-3 bg-green-600 hover:bg-green-700 text-white rounded-2xl transition font-black text-sm shadow-lg shadow-green-900/10 disabled:bg-green-400 uppercase tracking-widest"
                                >
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                {sessionState === 'idle' && (
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm flex flex-col items-center text-center">
                            ...
                            <div className="inline-flex items-center justify-center w-24 h-24 bg-green-50 rounded-full mb-4 border border-green-100">
                    ...
                    <div className="bg-white rounded-3xl p-12 border border-slate-200 text-center shadow-sm max-w-2xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100">
                                <div className="text-4xl font-black text-green-600 mb-1">#{sessionData.queuePosition}</div>
                ...
                {sessionState === 'starting' && (
                    <div className="bg-white rounded-3xl p-16 border border-slate-200 text-center shadow-sm max-w-2xl mx-auto">
                        <Loader2 className="w-20 h-20 text-green-600 animate-spin mx-auto mb-8" />
                                    ...
                                    <div className="space-y-10">
                                        {assignments.map(assignment => (
                                            <div key={assignment._id} className="space-y-4">
                                                <div className="bg-slate-50 rounded-2xl p-5 border border-green-100">
                                                    <h4 className="text-green-700 font-black text-xs uppercase tracking-tight">{assignment.title}</h4>
